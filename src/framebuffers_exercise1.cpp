...
int main()
{
    ...
    // -------------------------
	string path = FileSystem::getPath("src/5.2.framebuffers.vs");
    Shader shader(FileSystem::getPath("src/5.2.framebuffers.vs").c_str(), FileSystem::getPath("src/5.2.framebuffers.fs").c_str());
    Shader screenShader(FileSystem::getPath("src/5.2.framebuffers_screen.vs").c_str(), FileSystem::getPath("src/5.2.framebuffers_screen.fs").c_str());
